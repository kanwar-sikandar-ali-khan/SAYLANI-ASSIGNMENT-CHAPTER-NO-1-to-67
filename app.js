...
// function firstpic(){
//     var a = document.getElementById("fimg");
//     a.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTKngYrKJs3C-HWS_Jrl-xl6TIVdkUdzhye3A&usqp=CAU"
// }

// function secondpic(){

//     var a = document.getElementById("fimg");
//     a.src = "https://images.unsplash.com/photo-1523676060187-f55189a71f5e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80"
...
//     var b = document.getElementById("readmore1").innerHTML;
...
// var table1 = document.createElement("li");
// var txtnode1 = document.createTextNode(a.value);

// table1.appendChild(txtnode1);
// console.log(table1);
...
// var btncon = document.createTextNode("DELETE");

// deletebutton.appendChild(btncon);

// info.appendChild(deletebutton);

// deletebutton.setAttribute("onclick","khatam('this')")

// console.log(info);

// var editbutton = document.createElement("button");
// var btncon = document.createTextNode("EDIT");

// editbutton.appendChild(btncon);
...
// var childEle =   document.childNodes[1].childNodes[2].childNodes[1].childNodes[3].nextSibling.childNodes
...
// var renderClass = document.getElementsByClassName('render')[0].innerHTML;

// console.log(renderClass);


// var renderClass = document.getElementsByClassName('render')[1].innerHTML;
...
// var renderClass = document.getElementsByClassName('render')[2].innerHTML;

// console.log(renderClass);


// var renderClass = document.getElementsByClassName('render')[3].innerHTML;

// console.log(renderClass);


// var renderClass = document.getElementsByClassName('render')[4].innerHTML;
...
// firstName.value = "KANWAR SIKANDAR ALI"
...
// email.value = "kskh1361@gmail.com"
...
// var nodetype1 = document.getElementById("lastName").nodeType

// console.log(nodetype1);



// var nodetype2 = document.getElementById("lastName").childNodes[0].nodeType
...
// var childNode = document.getElementById("lastName").childNodes[0].replaceChild="sikandar";
...
//   var fl = document.getElementById("main-content").firstChild

// console.log(fl);


// var fl = document.getElementById("main-content").lastChild
...
//   var np = document.getElementById("lastName").nextSibling

// console.log(np);


// var np = document.getElementById("lastName").previousSibling
...
// var pnode = document.getElementById("email").parentNode.nodeType
